...
.btn { height: 28px; padding: 0 12px; background: #181818; border: none; border-radius: var(--radius-base); color: var(--text-secondary); font-size: var(--fs-meta); cursor: pointer; display: inline-flex; align-items: center; gap: 5px; }
