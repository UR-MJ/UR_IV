...
.eyebrow, .section-kicker { display: block; color: var(--accent); font-size: 8px; font-weight: 900; letter-spacing: 2px; }
...
.creator-tab { min-width: 94px; padding: 8px 13px; border: 0; border-radius: 8px; background: transparent; color: var(--text-muted); font-size: 10px; font-weight: 900; letter-spacing: 1px; cursor: pointer; }
...
.backend-state { justify-self: end; display: flex; align-items: center; gap: 7px; max-width: 190px; color: var(--text-muted); font-size: 9px; font-weight: 800; letter-spacing: 1px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
...
.progress-copy { min-width: 0; display: flex; flex-direction: column; }.progress-copy strong { color: var(--accent); font-size: 10px; text-transform: uppercase; }.progress-copy span { color: var(--text-muted); font-size: 9px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
...
.segmented button { padding: 5px 11px; border: 0; border-radius: 5px; color: var(--text-muted); background: transparent; font-size: 9px; font-weight: 900; cursor: pointer; }.segmented button.active { color: #000; background: var(--accent); }
.field { display: flex; flex-direction: column; gap: 5px; min-width: 0; }.field > span, .field-caption { color: var(--text-muted); font-size: 8px; font-weight: 900; letter-spacing: 1.2px; }
...
.toggle-field { min-height: 31px; display: flex; align-items: center; gap: 8px; padding-top: 14px; color: var(--text-secondary); font-size: 10px; font-weight: 700; }.toggle-field input { width: 15px; height: 15px; accent-color: var(--accent); }
.media-slot { min-height: 58px; display: flex; align-items: center; gap: 10px; padding: 8px; border: 1px solid var(--border); border-radius: 9px; background: var(--bg-card); }.slot-preview { width: 64px; height: 46px; flex: 0 0 auto; display: grid; place-items: center; overflow: hidden; border-radius: 5px; background: #080808; color: var(--text-muted); font-size: 8px; }.slot-preview img, .slot-preview video { width: 100%; height: 100%; object-fit: cover; }.slot-preview.audio { color: var(--accent); font-size: 20px; }
.slot-info { flex: 1; min-width: 0; display: flex; flex-direction: column; gap: 3px; }.slot-info b { font-size: 9px; letter-spacing: .8px; }.slot-info small { color: var(--text-muted); font-size: 9px; overflow: hidden; white-space: nowrap; text-overflow: ellipsis; }
button { font-family: inherit; }.primary-button, .secondary-button, .danger-button, .tool-button { border-radius: 7px; font-size: 9px; font-weight: 900; letter-spacing: .8px; cursor: pointer; transition: .15s ease; }.primary-button { min-height: 36px; padding: 9px 15px; border: 0; background: var(--accent); color: #050505; }.primary-button:hover:not(:disabled) { filter: brightness(1.08); transform: translateY(-1px); }.primary-button:disabled, button:disabled { opacity: .35; cursor: not-allowed; }
...
:deep(.output-empty) { max-width: 380px; display: flex; flex-direction: column; align-items: center; text-align: center; color: var(--text-muted); }:deep(.output-empty .output-mark) { color: var(--accent); font-size: 54px; opacity: .4; }:deep(.output-empty b) { color: var(--text-secondary); font-size: 12px; letter-spacing: 2px; }:deep(.output-empty p) { font-size: 10px; line-height: 1.6; }
:deep(.output-result) { width: 100%; height: 100%; min-height: 0; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 12px; }:deep(.output-result img), :deep(.output-result video) { max-width: 100%; max-height: calc(100% - 52px); min-height: 0; object-fit: contain; border-radius: 9px; box-shadow: 0 12px 40px rgba(0,0,0,.45); }:deep(.result-meta) { width: min(720px, 100%); display: flex; align-items: center; gap: 10px; }:deep(.result-meta b) { color: var(--accent); font-size: 9px; }:deep(.result-meta small) { flex: 1; color: var(--text-muted); font-size: 9px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.dual-media { display: grid; grid-template-columns: 1fr 1fr; gap: 10px; }.media-tile { min-height: 190px; display: grid; grid-template-rows: 1fr auto auto; gap: 3px; padding: 8px; border: 1px solid var(--border); border-radius: 10px; background: var(--bg-card); color: var(--text-primary); cursor: pointer; overflow: hidden; }.media-tile:hover { border-color: var(--accent); }.media-tile img { width: 100%; height: 150px; object-fit: cover; border-radius: 6px; }.media-tile b { font-size: 9px; }.media-tile > small { color: var(--text-muted); font-size: 8px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }.media-empty { min-height: 145px; display: flex; flex-direction: column; align-items: center; justify-content: center; color: var(--accent); font-size: 28px; background: var(--bg-input); border-radius: 6px; }.media-empty small { color: var(--text-muted); font-size: 8px; letter-spacing: 1px; }
.range-field { display: flex; flex-direction: column; gap: 7px; }.range-field > span { display: flex; justify-content: space-between; color: var(--text-muted); font-size: 8px; letter-spacing: 1px; }.range-field output { color: var(--accent); font: 11px monospace; }.range-field input { width: 100%; accent-color: var(--accent); }.range-field small { color: var(--text-muted); font-size: 9px; line-height: 1.5; }
...
.divider { height: 1px; flex: 0 0 auto; margin: 14px 0; background: var(--border); }.toolbar-row, .bubble-heading, .comic-stage-toolbar { display: flex; align-items: center; justify-content: space-between; gap: 7px; }.tool-button { padding: 6px 9px; border: 1px solid var(--border); background: var(--bg-button); color: var(--text-muted); }.tool-button:hover:not(:disabled) { color: var(--accent); border-color: var(--accent); }.save-state { margin-left: auto; color: var(--text-muted); font-size: 8px; }
...
.inspector-image { height: 135px; position: relative; display: grid; place-items: center; margin-bottom: 12px; overflow: hidden; border: 1px solid var(--border); border-radius: 8px; background: var(--bg-input); color: var(--text-muted); font-size: 9px; }.inspector-image img, .inspector-image video { width: 100%; height: 100%; object-fit: cover; }.inspector-image button { position: absolute; right: 6px; bottom: 6px; padding: 5px 8px; border: 1px solid var(--accent); border-radius: 5px; background: rgba(0,0,0,.78); color: var(--accent); font-size: 8px; font-weight: 900; cursor: pointer; }
.bubble-heading { margin-bottom: 7px; }.mini-accent { padding: 3px 7px; border: 1px solid var(--accent-dim); border-radius: 4px; background: var(--accent-dim); color: var(--accent); font-size: 8px; font-weight: 900; cursor: pointer; }.empty-small, .empty-inspector { color: var(--text-muted); font-size: 9px; text-align: center; padding: 15px 5px; }.empty-inspector { margin-top: 40px; }
...
.bubble-editor { margin-bottom: 8px; padding: 8px; border: 1px solid var(--border); border-radius: 7px; background: var(--bg-card); }.bubble-editor-head { display: grid; grid-template-columns: 1fr auto auto; align-items: center; gap: 6px; margin-bottom: 5px; }.bubble-editor-head select { padding: 4px 6px; }.bubble-editor-head span { color: var(--text-muted); font-size: 8px; }.bubble-editor-head button { border: 0; background: transparent; color: #f87171; font-size: 15px; cursor: pointer; }.bubble-position { display: grid; grid-template-columns: repeat(4, 1fr); gap: 4px; margin-top: 5px; }.bubble-position label { color: var(--text-muted); font-size: 7px; }.bubble-position input { padding: 4px; margin-top: 2px; }
