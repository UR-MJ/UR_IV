    ...
    def create_table(self):
        with self.conn:
            ...
            try:
                ...
                pass  # 이미 존재하면 무시
            self.conn.execute("CREATE INDEX IF NOT EXISTS idx_images_path ON images(path)")
            self.conn.execute("CREATE INDEX IF NOT EXISTS idx_images_hash ON images(image_hash)")
